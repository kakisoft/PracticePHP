...
|  命令     |  戻り値               |  使用例                              |
|:----------|:---------------------|:------------------------------------|
|  find()   |  Modelのオブジェクト   |  App\Model::find(1)                 |
|  first()  |  Modelのオブジェクト   |  App\Model::where('id',1)->first()  |
|  get()    |  Collectionクラス     |  App\Model::where('id',1)->get()    |
|  all()    |  Collectionクラス     |  App\Model::all()                   |
